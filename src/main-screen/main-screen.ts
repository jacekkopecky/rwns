import { animateWalletValue, fillOrHide, fillWalletEls, getEl, toggleHidden } from '#utils';
...
export function animateMainWallet(type: 'coin' | 'gem' | 'card', start: number, target: number) {
