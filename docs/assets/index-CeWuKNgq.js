...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Rd(){return new qn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Pd(){return new qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Go(){return`
...
`)}const _M={[Xf]:"Linear",[qf]:"Reinhard",[Yf]:"Cineon",[jf]:"ACESFilmic",[Zf]:"AgX",[Kf]:"Neutral",[$f]:"Custom"};function vM(n,t){const e=_M[t];return e===void 0?(Nt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const za=new L;function xM(){Qt.getLuminanceCoefficients(za);const n=za.x.toFixed(4),t=za.y.toFixed(4),e=za.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
